...
ax.set_xlabel("Age")
ax.set_ylabel("percentage of people who are lefthanded")

#-----------------------------------------------------------------------------------------------
# [2] Create a plot of the 'Mean_lh' column vs. 'Birth_year'.
#-----------------------------------------------------------------------------------------------
...
print(lefthanded_data.head()) #print the head titles 

# create a plot of the 'Mean_lh' column vs. 'Birth_year'
fig , ax = plt.subplots() #create figure and axis objects
ax.plot('Mean_lh' , 'Birth_year' , data=lefthanded_data , marker = 'x') #plot 'Mean_lh' vs 'Birth_year'
